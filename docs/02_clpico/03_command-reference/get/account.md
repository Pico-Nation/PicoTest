...
### Get formatted data for user **picoio**

```sh
clpico get account picoio
```
```console
privileged: true
permissions: 
...
producers:     <not voted>
```
### Get JSON data for user **picoio**

```sh
clpico get account picoio --json
```
```json
{
  "account_name": "picoio",
  ...
  "permissions": [{
      ...
      "required_auth": {
        "threshold": 1,
        "keys": [{
            "key": "PICO6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
            "weight": 1
          }
        ],
        "accounts": [],
