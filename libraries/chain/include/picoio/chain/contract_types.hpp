...
using action_name    = picoio::chain::action_name;
...
FC_REFLECT( picoio::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( picoio::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( picoio::chain::setabi                           , (account)(abi) )
FC_REFLECT( picoio::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( picoio::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( picoio::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( picoio::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( picoio::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( picoio::chain::onerror                          , (sender_id)(sent_trx) )
