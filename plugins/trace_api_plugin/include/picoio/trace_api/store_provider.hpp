...
#include <picoio/trace_api/common.hpp>
#include <picoio/trace_api/metadata_log.hpp>
#include <picoio/trace_api/data_log.hpp>
#include <picoio/trace_api/compressed_file.hpp>

namespace picoio::trace_api {
...
FC_REFLECT(picoio::trace_api::slice_directory::index_header, (version))
