...
- `--stake-net` _TEXT_ - The amount of PICO delegated for net bandwidth
- `--stake-cpu` _TEXT_  - The amount of PICO delegated for CPU bandwidth
- `--buy-ram-bytes` _UINT_ - The amount of RAM bytes to purchase for the new account in kilobytes KiB, default is 8 KiB
- `--buy-ram-PICO` _TEXT_ - The amount of RAM bytes to purchase for the new account in PICO
- `--transfer` - Transfer voting power and right to unstake PICO to receiver
