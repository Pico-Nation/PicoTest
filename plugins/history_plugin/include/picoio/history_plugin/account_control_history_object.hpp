...
CHAINBASE_SET_INDEX_TYPE( picoio::account_control_history_object, picoio::account_control_history_multi_index )

FC_REFLECT( picoio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
