...
CHAINBASE_SET_INDEX_TYPE(picoio::chain::generated_transaction_object, picoio::chain::generated_transaction_multi_index)

FC_REFLECT(picoio::chain::generated_transaction_object, (trx_id)(sender)(sender_id)(payer)(delay_until)(expiration)(published)(packed_trx))
