...
###############################################################
# nodpico_chainbase_allocation_test
#
...
try:
    ...
    # (automatically taken care by the automatically generated picoio account)
    assert cluster.launch(
        ...
        specificExtraNodpicoArgs={
            1:"--read-mode irreversible --plugin picoio::producer_api_plugin"})
