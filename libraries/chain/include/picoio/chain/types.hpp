...
namespace picoio { namespace chain {
   ...
   /**
    *  Important notes on using chainbase objects in PICOIO code:
    *
    ...
    *  others are due to requirements to ensure determinism in the PICOIO chain library.
    *
...
FC_REFLECT_EMPTY( picoio::chain::void_t )
