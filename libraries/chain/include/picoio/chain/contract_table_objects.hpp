...
#include <picoio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(picoio::chain::table_id_object, picoio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(picoio::chain::key_value_object, picoio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(picoio::chain::index64_object, picoio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(picoio::chain::index128_object, picoio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(picoio::chain::index256_object, picoio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(picoio::chain::index_double_object, picoio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(picoio::chain::index_long_double_object, picoio::chain::index_long_double_index)

FC_REFLECT(picoio::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(picoio::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(picoio::chain::index64_object)
REFLECT_SECONDARY(picoio::chain::index128_object)
REFLECT_SECONDARY(picoio::chain::index256_object)
REFLECT_SECONDARY(picoio::chain::index_double_object)
REFLECT_SECONDARY(picoio::chain::index_long_double_object)
