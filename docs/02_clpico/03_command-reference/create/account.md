...
## Command
A set of PICOIO keys is required to create an account. The PICOIO keys can be generated by using `clpico create key`.

```sh
clpico create account inita tester PICO4toFS3YXEQCkuuw1aqDLrtHim86Gz9u3hBdcBw5KNPZcursVHq PICO7d9A3uLe6As66jzN8j44TXJUqJSK3bFjjEEqR4oTvNAB3iM9SA
```
