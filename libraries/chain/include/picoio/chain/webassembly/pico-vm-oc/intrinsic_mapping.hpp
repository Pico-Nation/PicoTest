...
constexpr auto intrinsic_table = boost::hana::make_tuple(
   "picovmoc_internal.unreachable"_s,
   "picovmoc_internal.grow_memory"_s,
   "picovmoc_internal.div0_or_overflow"_s,
   "picovmoc_internal.indirect_call_mismatch"_s,
   "picovmoc_internal.indirect_call_oob"_s,
   "picovmoc_internal.depth_assert"_s,
   "picoio_injection.call_depth_assert"_s,  //these two are never used by PICO VM OC but all intrinsics
   "picoio_injection.checktime"_s,          //must be mapped
   "env.__ashlti3"_s,
   "env.__ashrti3"_s,
   "env.__lshlti3"_s,
   "env.__lshrti3"_s,
   ...
   "env.get_sender"_s,
   "env.abort"_s,
   "env.picoio_assert"_s,
   "env.picoio_assert_message"_s,
   "env.picoio_assert_code"_s,
   "env.picoio_exit"_s,
   ...
   "env.memcmp"_s,
   "env.memset"_s,
   "picoio_injection._picoio_f32_add"_s,
   "picoio_injection._picoio_f32_sub"_s,
   "picoio_injection._picoio_f32_mul"_s,
   "picoio_injection._picoio_f32_div"_s,
   "picoio_injection._picoio_f32_min"_s,
   "picoio_injection._picoio_f32_max"_s,
   "picoio_injection._picoio_f32_copysign"_s,
   "picoio_injection._picoio_f32_abs"_s,
   "picoio_injection._picoio_f32_neg"_s,
   "picoio_injection._picoio_f32_sqrt"_s,
   "picoio_injection._picoio_f32_ceil"_s,
   "picoio_injection._picoio_f32_floor"_s,
   "picoio_injection._picoio_f32_trunc"_s,
   "picoio_injection._picoio_f32_nearest"_s,
   "picoio_injection._picoio_f32_eq"_s,
   "picoio_injection._picoio_f32_ne"_s,
   "picoio_injection._picoio_f32_lt"_s,
   "picoio_injection._picoio_f32_le"_s,
   "picoio_injection._picoio_f32_gt"_s,
   "picoio_injection._picoio_f32_ge"_s,
   "picoio_injection._picoio_f64_add"_s,
   "picoio_injection._picoio_f64_sub"_s,
   "picoio_injection._picoio_f64_mul"_s,
   "picoio_injection._picoio_f64_div"_s,
   "picoio_injection._picoio_f64_min"_s,
   "picoio_injection._picoio_f64_max"_s,
   "picoio_injection._picoio_f64_copysign"_s,
   "picoio_injection._picoio_f64_abs"_s,
   "picoio_injection._picoio_f64_neg"_s,
   "picoio_injection._picoio_f64_sqrt"_s,
   "picoio_injection._picoio_f64_ceil"_s,
   "picoio_injection._picoio_f64_floor"_s,
   "picoio_injection._picoio_f64_trunc"_s,
   "picoio_injection._picoio_f64_nearest"_s,
   "picoio_injection._picoio_f64_eq"_s,
   "picoio_injection._picoio_f64_ne"_s,
   "picoio_injection._picoio_f64_lt"_s,
   "picoio_injection._picoio_f64_le"_s,
   "picoio_injection._picoio_f64_gt"_s,
   "picoio_injection._picoio_f64_ge"_s,
   "picoio_injection._picoio_f32_promote"_s,
   "picoio_injection._picoio_f64_demote"_s,
   "picoio_injection._picoio_f32_trunc_i32s"_s,
   "picoio_injection._picoio_f64_trunc_i32s"_s,
   "picoio_injection._picoio_f32_trunc_i32u"_s,
   "picoio_injection._picoio_f64_trunc_i32u"_s,
   "picoio_injection._picoio_f32_trunc_i64s"_s,
   "picoio_injection._picoio_f64_trunc_i64s"_s,
   "picoio_injection._picoio_f32_trunc_i64u"_s,
   "picoio_injection._picoio_f64_trunc_i64u"_s,
   "picoio_injection._picoio_i32_to_f32"_s,
   "picoio_injection._picoio_i64_to_f32"_s,
   "picoio_injection._picoio_ui32_to_f32"_s,
   "picoio_injection._picoio_ui64_to_f32"_s,
   "picoio_injection._picoio_i32_to_f64"_s,
   "picoio_injection._picoio_i64_to_f64"_s,
   "picoio_injection._picoio_ui32_to_f64"_s,
   "picoio_injection._picoio_ui64_to_f64"_s
);
