...
CHAINBASE_SET_INDEX_TYPE(picoio::chain::permission_object, picoio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(picoio::chain::permission_usage_object, picoio::chain::permission_usage_index)

FC_REFLECT(picoio::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(picoio::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(picoio::chain::permission_usage_object, (last_used))
