...
FC_REFLECT(picoio::chain::protocol_feature_subjective_restrictions,
               (earliest_allowed_activation_time)(preactivation_required)(enabled))

FC_REFLECT(picoio::chain::protocol_feature_base,
               (protocol_feature_type)(dependencies)(description_digest)(subjective_restrictions))

FC_REFLECT_DERIVED(picoio::chain::builtin_protocol_feature, (picoio::chain::protocol_feature_base),
