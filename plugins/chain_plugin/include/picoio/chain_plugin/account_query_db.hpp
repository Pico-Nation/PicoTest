...
namespace picoio::chain_apis {
   ...
   public:
       ...
       */
      account_query_db( const class picoio::chain::controller& chain );
      ~account_query_db();
...
namespace fc {
   using params = picoio::chain_apis::account_query_db::get_accounts_by_authorizers_params;
   /**
   ...
   inline void from_variant(const fc::variant& v, params::permission_level& a) {
      if (v.is_string()) {
         ...
         if(vo.contains("actor"))
            ...
            PICO_THROW(picoio::chain::invalid_http_request, "Missing Actor field");
         ...
         if(vo.contains("permission") && vo.size() == 2)
            ...
            PICO_THROW(picoio::chain::invalid_http_request, "Unrecognized fields in account");
      }
   }
}

FC_REFLECT( picoio::chain_apis::account_query_db::get_accounts_by_authorizers_params, (accounts)(keys))
FC_REFLECT( picoio::chain_apis::account_query_db::get_accounts_by_authorizers_result::account_result, (account_name)(permission_name)(authorizing_account)(authorizing_key)(weight)(threshold))
FC_REFLECT( picoio::chain_apis::account_query_db::get_accounts_by_authorizers_result, (accounts))
