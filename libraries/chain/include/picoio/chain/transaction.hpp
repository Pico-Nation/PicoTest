...
#include <picoio/chain/action.hpp>
#include <numeric>
...
FC_REFLECT(picoio::chain::deferred_transaction_generation_context, (sender_trx_id)(sender_id)(sender) )
FC_REFLECT( picoio::chain::transaction_header, (expiration)(ref_block_num)(ref_block_prefix)
                                              (max_net_usage_words)(max_cpu_usage_ms)(delay_sec) )
FC_REFLECT_DERIVED( picoio::chain::transaction, (picoio::chain::transaction_header), (context_free_actions)(actions)(transaction_extensions) )
FC_REFLECT_DERIVED( picoio::chain::signed_transaction, (picoio::chain::transaction), (signatures)(context_free_data) )
FC_REFLECT_ENUM( picoio::chain::packed_transaction::compression_type, (none)(zlib))
// @ignore unpacked_trx
FC_REFLECT( picoio::chain::packed_transaction, (signatures)(compression)(packed_context_free_data)(packed_trx) )
