...
CHAINBASE_SET_INDEX_TYPE(picoio::chain::permission_link_object, picoio::chain::permission_link_index)

FC_REFLECT(picoio::chain::permission_link_object, (account)(code)(message_type)(required_permission))
