...
- `sender` _TEXT_ - The account sending PICO
- `recipient` _TEXT_ - The account receiving PICO
- `amount` _UINT_ - The amount of PICO to send
...
```sh
clpico transfer inita tester 1000
```
