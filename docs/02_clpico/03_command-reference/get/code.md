...
## Examples
Simply output the hash of picoio.token contract 

```sh
clpico get code picoio.token
```
```console
...
```sh
clpico get code picoio.token -a picoio.token.abi
```
```console
code hash: f675e7aeffbf562c033acfaf33eadff255dacb90d002db51c7ad7cbf057eb791
...
Retrieve and save wast code for picoio.token contract

```sh
clpico get code picoio.token -c picoio.token.wast
```
```console
code hash: f675e7aeffbf562c033acfaf33eadff255dacb90d002db51c7ad7cbf057eb791
saving wast to picoio.token.wast
```
