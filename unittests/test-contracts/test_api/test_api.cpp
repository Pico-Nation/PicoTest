...
extern "C" {
   void apply( uint64_t receiver, uint64_t code, uint64_t action ) {
      if( code == "picoio"_n.value && action == "onerror"_n.value ) {
         auto error = picoio::onerror::from_current_action();
         picoio::print("onerror called\n");
      ...
      //unhandled test call
      picoio_assert( false, "Unknown Test ahhh!" );
