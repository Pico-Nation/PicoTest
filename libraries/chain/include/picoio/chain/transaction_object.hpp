...
CHAINBASE_SET_INDEX_TYPE(picoio::chain::transaction_object, picoio::chain::transaction_multi_index)

FC_REFLECT(picoio::chain::transaction_object, (expiration)(trx_id))
