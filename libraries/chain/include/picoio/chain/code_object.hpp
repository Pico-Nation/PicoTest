...
CHAINBASE_SET_INDEX_TYPE(picoio::chain::code_object, picoio::chain::code_index)

FC_REFLECT(picoio::chain::code_object, (code_hash)(code)(code_ref_count)(first_block_used)(vm_type)(vm_version))
