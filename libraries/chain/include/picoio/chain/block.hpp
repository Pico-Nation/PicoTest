...
FC_REFLECT_ENUM( picoio::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(picoio::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(picoio::chain::transaction_receipt, (picoio::chain::transaction_receipt_header), (trx) )
FC_REFLECT(picoio::chain::additional_block_signatures_extension, (signatures));
FC_REFLECT_DERIVED(picoio::chain::signed_block, (picoio::chain::signed_block_header), (transactions)(block_extensions) )
