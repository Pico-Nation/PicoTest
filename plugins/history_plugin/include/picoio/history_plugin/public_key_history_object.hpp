...
CHAINBASE_SET_INDEX_TYPE( picoio::public_key_history_object, picoio::public_key_history_multi_index )

FC_REFLECT( picoio::public_key_history_object, (public_key)(name)(permission) )
