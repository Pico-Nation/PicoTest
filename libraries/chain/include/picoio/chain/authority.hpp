...
FC_REFLECT(picoio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(picoio::chain::key_weight, (key)(weight) )
FC_REFLECT(picoio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(picoio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(picoio::chain::shared_key_weight, (key)(weight) )
FC_REFLECT(picoio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(picoio::chain::shared_public_key, (pubkey))