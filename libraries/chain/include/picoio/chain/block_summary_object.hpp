...
CHAINBASE_SET_INDEX_TYPE(picoio::chain::block_summary_object, picoio::chain::block_summary_multi_index)

FC_REFLECT( picoio::chain::block_summary_object, (block_id) )
