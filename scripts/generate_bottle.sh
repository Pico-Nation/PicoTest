...
mkdir -p ${PROJECT}/${VERSION}/opt/picoio/lib/cmake
...
echo "class Picoio < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/picoio/pico/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/picoio/pico/releases/download/v${VERSION}\"
