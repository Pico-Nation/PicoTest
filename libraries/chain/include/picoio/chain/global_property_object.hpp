...
#include <picoio/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(picoio::chain::global_property_object, picoio::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(picoio::chain::dynamic_global_property_object,
                         picoio::chain::dynamic_global_property_multi_index)

FC_REFLECT(picoio::chain::global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)
          )

FC_REFLECT(picoio::chain::legacy::snapshot_global_property_object_v2,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)
          )

FC_REFLECT(picoio::chain::snapshot_global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)
          )

FC_REFLECT(picoio::chain::dynamic_global_property_object,
