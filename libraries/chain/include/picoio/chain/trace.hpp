...
#include <picoio/chain/action_receipt.hpp>
...
FC_REFLECT( picoio::chain::account_delta,
            (account)(delta) )

FC_REFLECT( picoio::chain::action_trace,
...
FC_REFLECT( picoio::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
